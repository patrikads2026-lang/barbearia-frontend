...
export default function Painel() {
  ...
  const [barbeiros, setBarbeiros] = useState(["Thiago", "Adriano", "Carlos"]);
  ...
  async function removerBloqueio(id) {
    await fetch(`${API}/api/bloqueios/${id}`, {
      method: "DELETE",
    });
  ...
  function salvarEdicao(nomeAntigo) {
    ...
    setBarbeiros((prev) =>
      prev.map((b) => (b === nomeAntigo ? nomeEditado.trim() : b))
    );
  ...
  const agTodos = [...agendamentos].sort(
    ...
    return (
      <div className="painel-wrap">
        <div className="painel-login">
          ...
          <button className="painel-btn" onClick={login}>
            Entrar
          </button>
        </div>
      </div>
    ...
    <div className="painel-wrap">
      <div className="painel-container">
        <div className="painel-header">
          ...
          <button className="painel-sair" onClick={() => setLogado(false)}>
            Sair
          </button>
        </div>
        ...
        <div className="painel-abas">
          {["hoje", "historico", "bloquear", "barbeiros"].map((a) => (
            <button
              key={a}
              className={`painel-aba ${aba === a ? "active" : ""}`}
              onClick={() => setAba(a)}
            >
              {a === "hoje"
                ? "Hoje"
              ...
              agHoje.map((a) => (
                <div key={a.id} className="painel-item">
                  <div className="painel-item-info">
                    ...
                    <span>
                      {a.horario} - {a.servico} c/ {a.barbeiro}
                    </span>
                  ...
                  <div className="painel-item-acoes">
                    <span
                      ...
                      style={{ background: statusCor[a.status] }}
                    >
                      {a.status}
                    </span>
              ...
              agTodos.map((a) => (
                <div key={a.id} className="painel-item">
                  <div className="painel-item-info">
                    ...
                    <span>
                      {a.data} as {a.horario} - {a.servico} c/{" "}
                      {a.barbeiro}
                    </span>
